...
str = Console.Read(); // str = Console.ReadLine();
Console.WriteLine("You entered: "+str);
```

➢ รันโปรแกรมและบันทึกผล
![image](https://user-images.githubusercontent.com/115066359/232071211-e549e02e-fe06-4f2b-a62e-67f21224afc5.png)
...
![image](https://user-images.githubusercontent.com/115066359/232076424-bce394b1-85d1-44b0-abb5-714f781127ed.png)


❔ ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร
ถ้าป้อนตัวอีกศรแทนตัวเลข จะเกิด error วิธีป้องกันให้ใช้เมธอด int.TryParse() มาช่วยแปลงค่าที่ผู้ใช้ป้อนผ่าน Console.ReadLine() ให้เป็น int โดยไม่เกิด Exception
...
![image](https://user-images.githubusercontent.com/115066359/232078737-acf27229-409f-4c1c-a41e-f286165d8547.png)
...
➢ รันโปรแกรมและบันทึกผล
![image](https://user-images.githubusercontent.com/115066359/232081666-111c11d6-3188-4018-be87-944f5fc53f03.png)
